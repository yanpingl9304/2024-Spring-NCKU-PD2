...
ANSWERS = [
    ...
    f"{ANS_DIR}/ans4.csv",
    f"{ANS_DIR}/ans5.csv",
    f"{ANS_DIR}/ans5_1.csv",
    f"{ANS_DIR}/ans5_2.csv",
    f"{ANS_DIR}/ans5_3.csv",
    f"{ANS_DIR}/ans5_4.csv",
    f"{ANS_DIR}/ans6.csv",
    f"{ANS_DIR}/ans6_1.csv",
    f"{ANS_DIR}/ans6_2.csv",
    f"{ANS_DIR}/ans6_3.csv",
    f"{ANS_DIR}/ans7.csv",
    f"{ANS_DIR}/ans7_1.csv",
    f"{ANS_DIR}/ans7_2.csv",
    f"{ANS_DIR}/ans7_3.csv",
    f"{ANS_DIR}/ans8.csv",
    f"{ANS_DIR}/ans8_1.csv",
    f"{ANS_DIR}/ans8_2.csv",
    f"{ANS_DIR}/ans8_3.csv",
    f"{ANS_DIR}/ans8_4.csv",
    f"{ANS_DIR}/ans9.csv",
    f"{ANS_DIR}/ans9_1.csv",
    f"{ANS_DIR}/ans9_2.csv",
]
